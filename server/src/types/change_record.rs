//! `ChangeRecord` proto conversion.
//!
//! Provides conversion between storage `ChangeRecord`/`ChangeType` and proto equivalents.

use crate::proto;
use crate::storage::{ChangeRecord, ChangeType};
