...
/**
 * In-memory mock store for testing purposes.
 *
 * Implements StoreInterface for compatibility with NetworkStore.
 * This store is only used for unit testing and should not be used in production.
 */
export class MockStore implements StoreInterface {
